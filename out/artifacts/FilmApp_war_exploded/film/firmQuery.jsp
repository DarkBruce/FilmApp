...
<div class="bh">
    <div class="header">
        <div class="logo">
            <h1><a href="firmquery.html"><img src="../img/logo.png" alt=""></a></h1>
        </div>
...
<div class="div-right2">
    ...
    <form action="${pageContext.request.contextPath}/FirmQuery" method="post" class="layui-form layui-form-pane">
        <tr >
            <td >
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="FirmName" name="FirmName" lay-verify="required" placeholder="请输入名称" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </td>
        </tr>
