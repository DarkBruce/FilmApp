...
<div class="maincontainer" style="margin-left: 20px;margin-right: 20px">
    <div class="layui-row">
        <div class="layui-col-xs6">
            ...
            <table class="easyui-datagrid" title="电影信息" style="width:800px;height:480px"
        ...
        <div class="layui-col-xs6" style="margin-top: 20px">
            <div align="center">
                <button id="1" type="submit" class="layui-btn layui-btn-primary layui-btn-radius" style="margin-top: 30px;" onclick="window.location.href='filmchange_insert.html'">添加记录</button>
                <p></p>
                ...
                <p></p>
                <button id="3" type="submit" class="layui-btn layui-btn-normal layui-btn-radius" style="margin-top: 30px;" onclick="window.location.href='filmchange_update.html'">更新记录</button>
            </div>
        </div>
    </div>
</div>
