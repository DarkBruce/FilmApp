...
<div class="bh">
    <div class="header">
        <div class="logo">
            <h1><a href="register.html"><img src="img/logo.png" alt=""></a></h1>
        </div>
    ...
    <form class="layui-form" method="post" >
        ...
        <div class="layui-input-inline">
            <div class="layui-form-item" style="margin-right: 100px;margin-top: 20px;">
                ...
                <div class="layui-input-block">
                    <input type="text" id="wbnm" name="webname" required  lay-verify="required" placeholder="请输入昵称" autocomplete="off" class="layui-input">
                </div>
            </div>
        </div>
        <div style="text-align: center;">
            <input type="submit" class="layui-btn layui-btn-normal"  value="注&nbsp;&nbsp;&nbsp;&nbsp;册"/>
        </div>
        <hr style="width: 100%" />
